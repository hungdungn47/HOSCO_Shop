...
class SalesReport extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Text("Báo cáo kinh doanh")),
      body: Padding(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: DropdownButtonFormField<TimeRange>(
                      ...
                      onChanged: (value) => salesReportController
                          .timeRange.value = value ?? TimeRange.thisWeek,
              ...
              // }),
              Center(
                  child: Obx(() => BestSellingProductsTable(
                      products:
                          salesReportController.bestSellingProducts.toList())))
            ],
          ),
        ),
      ),
