          ...
          Padding(
            ...
            child: GestureDetector(onTap: () {
              ...
              return Image(
                ...
                height: 25,
                width: 25,
                image: AssetImage(cartController.isBarcodeOn.value
                    ? 'assets/icons/barcode_off_icon.png'
            ...
            children: [
              ...
              Column(
                children: [
                  ...
                  Obx(() {
                    return cartController.isBarcodeOn.value
                        ? Container(
                            width: 300,
                            height: 150,
                            ...
                            child: SimpleBarcodeScanner(
                              ...
                              onScanned: (code) async {
                                if (cartController.productIdSet.contains(code))
                                  return;
                                cartController.productIdSet.add(code);
                                print(code);
                                Product? newProduct = await productController
                                    .getProductById(code);
                                if (newProduct == null) {
                                  AwesomeDialog(
                                    context: context,
                                      ...
                                      .map((suggestion) => ListTile(
                                            ...
                                            onTap: () {
                                              FocusScope.of(context)
                                                  .requestFocus(
                                                      new FocusNode());
                                              cartController.isShowSuggestion
                                                  .value = false;
                                              searchQueryController.clear();
                                              cartController.clearSearchQuery();
                                              cartController
