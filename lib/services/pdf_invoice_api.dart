...
class PdfInvoiceApi {
  ...
  static Widget buildInvoiceInfo(InvoiceInfo info) {
    ...
    final data = <String>[
      info.number,
      Formatters.formatDate(info.date),
      paymentTerms,
      Formatters.formatDate(info.dueDate),
    ];
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                buildText(
                  title: 'Net total',
                  value: Formatters.formatPrice(netTotal),
                  unite: true,
                ),
                buildText(
                  title: 'Vat ${vatPercent * 100} %',
                  value: Formatters.formatPrice(vat),
                  unite: true,
                ),
                Divider(),
                buildText(
  ...
  static Widget buildFooter(Invoice invoice) => Column(
        ...
        children: [
          ...
          SizedBox(height: 2 * PdfPageFormat.mm),
          buildSimpleText(
              title: 'Address', value: invoice.supplier.address ?? "Unknown"),
          // SizedBox(height: 1 * PdfPageFormat.mm),
