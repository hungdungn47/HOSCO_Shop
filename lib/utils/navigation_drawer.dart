...
class MyNavigationDrawer extends StatelessWidget {
  ...
  Widget _buildHeader() {
    return Padding(
      ...
      child: Text('HOSCO Shop', style: TextStyle(
        fontSize: 32,
  ...
  Widget _buildMenuItems(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(
        children: [
          ListTile(
            leading: Image.asset('assets/icons/shop_icon.png', height: iconSize, width: iconSize,),
            title: Text('Quản lý sản phẩm', style: whiteMedium,),
            onTap: () {
          ...
          ListTile(
            leading: Image.asset('assets/icons/history_icon.png', height: iconSize, width: iconSize,),
            title: Text('Lịch sử giao dịch', style: whiteMedium,),
            onTap: () {
              Navigator.pop(context);
          ...
          ListTile(
            ...
            title: Text('Báo cáo kinh doanh ', style: whiteMedium,),
            onTap: () {
              Navigator.pop(context);
